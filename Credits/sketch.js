...
fileName = "./frames/carton-04/carton-04";
let maxFrames = 1500;
// maxFrames = 925;
maxFrames = 3000;
maxFrames = 500;
...
function setup() {
    ...
    image = new Image();
    image.src = "carton-04.png"; // MUST BE SAME DOMAIN!!!
...
draw = function() {
    ...
    if (imageLoaded) {
        gl.useProgram(shaderPrograms["image"].shaderProgram);
        drawImage(shaderPrograms["image"].shaderProgram, image);
    }
