    ...
    for (let x = 0; x < face[0].length; x++) {
         for (let y = 0; y < face.length; y++) {
            let p = face[y][x];
             ...
             let sc = 1;
             let tx = -0.49, ty = 0.45;
             let osc = Math.sin(drawCount * 1e-1 + 1e-1 * x) * 0.1 - 0.4;
             if (p == "1") {
                 let xx = x * 0.0025 * sc * (9 / 16) * 4 * 1.6 + tx;
                 let yy = -y * 2.65 * sc * 0.0126 + Math.sin(drawCount * 0.25 + y * 0.25) * 0.0025 + ty - 0.02;
...
roundedSquare.fragText = `
    ...
    void main(void) {
         ...
         vec2 uv = gl_PointCoord.xy;
        uv = uv * 2. - 1.;
        float color = roundedRectangleFlicker(uv, vec2(0.0, 0.0), vec2(0.13, 0.3) * 4., 0.001, 0.1);
...
vt2.makeTerminalString();
            ...
            "..........................1111111111111111111111111111111111111111111111111111.................",
            ".........................111111111111111111111111144444444444444444444444441111................",
            ".........................111111111111111111111111221111111114444444411111111111................",
            ".........................111111111111111111111111222333333331133441144444444111................",
            "........................1111111111111111111111112223222112232222344443331134111................",
            "........................1111111111111111111111112233222112233222344433331134111................",
            "........................11111111111111111111111122223333333222223444444444441111...............",
            ".......................111111111111111111111111122222222222222222344444444441111...............",
            ".......................111111111111111111111111112222222222222222234444444441111...............",
            ".......................111111111111111111111111112222222222222222234444444441111...............",
            ".......................111111111111111111111111112222222222233334444433444411111...............",
            ".......................111111111111111111111111111222222222222233332223334111111...............",
            "......................1111111111111111111111111111222222222222233332222234111111...............",
            "......................1111111111111111111111111111222222222111111112222341111111...............",
            "......................1111111111111111111111111111122222221111111122223411111111...............",
            "......................1111111111111111111111111111122222222222222222234111111111...............",
            "......................1111111111111111111111111111133222222222222222341111111111...............",
            "......................1111111111111111111111111111133333222222222234111111111111...............",
            "......................1111111111111111111111111111133333333334411111111111111111...............",
            "......................1111111111111111111111111111133333333444111111111111111111...............",
            ".....................1111111111111111111111111111113333333441111111111111111111................",
            ".....................1111111111111111111111111111111333334411111111111111111111................",
            ".....................1111111111111111111111111111111133334411111111111111111111................",
