         ...
         for (let y = 0; y < face.length; y++) {
            let p = face[y][x];
             ...
             if (p !== ".") {
                 ...
                 vertices.push(xx * 0.85 * 2.5, yy, 20.0 * sc * 0.9, 1);
             num++;
             }
                 if (p == "1") {  let c = Math.pow(y,2) * 0.00625 * 0.045 * 0.05;
                 colors.push(c, c, c);
...
drawTerminal2 = function() {
    ...
    colors = [];
        ...
        for (let y = 0; y < 9; y++) {
            if (vt3.stringArray[y][x] == "1") {
                ...
                let tx = 0, ty = 0;
                tx = openSimplex.noise3D(ox * 0.005, oy * 0.005, 100) * 0.05;
                ty = openSimplex.noise3D(ox * 0.01, oy * 0.01, 200) * 0.02;
                vertices.push(
                    ox * (9 / 16) * 0.02 * sc + nx + (-y * 0.002) + 0.1, 
                    -oy * 0.04 * sc + ny + 0.01, 
                    50.0 * sc * 0.9 + tx * 500, 
                    1
                );
    ...
    for (let x = 8; x <= vt4.stringArray[0].length; x++) {
        for (let y = 0; y < 9; y++) {
            if (vt4.stringArray[y][x] == "1") {
                ...
                tx = openSimplex.noise3D(ox * 0.005, oy * 0.005, 100) * 0.05;
                ty = openSimplex.noise3D(ox * 0.01, oy * 0.01, 200) * 0.02;
               vertices.push(ox * 3 * (9 / 16) * 0.02 * sc - 0.51 + nx + (-oy * 0.002), -oy * 0.04 * sc - 0.39 + 0.1 + ny + ((Math.sin(x * 0.05) * 0.5 + 0.5) * 0.0) - 0.05, 50.0 * sc * 0.9 + tx * 500, 1);
            num++;
                colors.push(0.65, 0.65, 0.65);
            }
        }
    }
    for (let x = 8; x <= vt5.stringArray[0].length; x++) {
        for (let y = 0; y < 9; y++) {
            if (vt5.stringArray[y][x] == "1") {
                                let oy = y + 12;
                let ox = x * 1 - 10;
                if (x > 15 * 7) {
                    oy += 4;
                    ...
                    ox *= 2 * (1/x) * 1.5e2;
                                ...
                                let tx = 0, ty = 0;
                tx = openSimplex.noise3D(ox * 0.005, oy * 0.005, 100) * -0.1;
                ty = openSimplex.noise3D(ox * 0.01, oy * 0.01, 200) * 0.02;
               vertices.push(ox * 3 * (9 / 16) * 0.02 * sc - 0.51 + nx + (-oy * 0.002), -oy * 0.04 * sc - 0.39 + 0.1 + ny + ((Math.sin(x * 0.05) * 0.5 + 0.5) * 0.00) - 0.05, 50.0 * sc * 0.9 + tx * 500, 1);
            num++;
                colors.push(0.65, 0.65, 0.65);
            }
        }
    }
    for (let x = 8; x <= vt6.stringArray[0].length; x++) {
        for (let y = 0; y < 9; y++) {
            if (vt6.stringArray[y][x] == "1") {
                                let oy = y + 35;
                let ox = x * 1 - 10;
                if (x > 19 * 7) {
                    oy += 9;
    ...
    for (let x = 8; x <= vt7.stringArray[0].length; x++) {
        for (let y = 0; y < 9; y++) {
            if (vt7.stringArray[y][x] == "1") {
                                let oy = y + 74;
                let ox = x * 1 + 100;
                                let tx = 0, ty = 0;
                tx = openSimplex.noise3D(ox * 0.005, oy * 0.005, 100) * -0.025;
                ty = openSimplex.noise3D(ox * 0.01, oy * 0.01, 200) * 0.02;
               vertices.push(ox * 3 * (9 / 16) * 0.02 * sc * 0.75 - 0.51 + nx + (-oy * 0.002), -oy * 0.04 * sc * 0.75 - 0.39 + 0.1 + ny + ((Math.sin(x * 0.05) * 0.5 + 0.5) * 0.0) - 0.05, 30.0 * sc * 0.9 + tx * 700, 1);
            num++;
                colors.push(0.65, 0.65, 0.65);
            }
        }
    }
    let selectedProgram = getProgram("rounded-square-prev");
...
let roundedSquarePrev = new ShaderProgram("rounded-square-prev");

roundedSquarePrev.vertText = `
    // beginGLSL
...
roundedSquare.fragText = `
    ...
    void main(void) {
       ...
       float vig = (roundedRectangle(gl_FragCoord.xy, vec2(1280./ 2.0, 720./ 2.), vec2(0.761, 0.396) * 772., 30.5, 70.5) + 0.0);
        gl_FragColor = vec4((cols - rando) * 1., color);
    }
    // endGLSL
`;
roundedSquare.init();
...
vt3.text = "O! still--ye shadowy forms!";
vt3.makeTerminalString();



let vt4 = new VirtualTerminal();
vt4.text = "attend my lonely hours,";
vt4.makeTerminalString();

let vt5 = new VirtualTerminal();
vt5.text = "Still chase my real cares";
vt5.makeTerminalString();


let vt6 = new VirtualTerminal();
vt6.text = "with your illusive powers!";
vt6.makeTerminalString();


let vt7 = new VirtualTerminal();
vt7.text = "- Ann Radcliffe";
vt7.makeTerminalString();
...
face = [
".3341..4411144411111....334411...........333444111..................................334411........43314341113344111333444113344111....333441...",
"33341.34411144411111.....334411.........333444111....................................334411.......4331434111334411133344411334411......333441..",
"33341.34411144411111.....334411........333444111.....................................334411.......4331434111334411.33344411334411......333441..",
...
".334411...3344411111........333444111...111111111111111111111444444444444411111111111111........33441143411111...33441114111..........333441...",
"334411....3344411111.......333444111....11111111111111111112221111111114444411111111111..........3344443411111..334411144111.........333441....",
"334411....3344411111......333444111.....11111111111111111112222333333331133411111111111..........3334443411111.1134111444111.........333441....",
".334411...3344411111.....333444111.....111111111111111111122223222112232222311111111111..........3333343411111.1111113444111........3334411....",
".334411...3344411111....333444111......111111111111111111122233222112233222311111111111..........3333343411111.1111113444111........3334411....",
".334411...3344111111....113444111......111111111111111111122222333333322222311111111111..........333344341111111111113444111.......3334411.....",
"..334411..3344111111...111144111......1111111111111111111122222222222222222231111111111..........333343441111111111133444111.......3334411.....",
"..334411..3344111111..111111111.......1111111111111111111122222222222222222223111111111..........333343441111111111333444111......3334411......",
"..334411.33344111111.111111111........1111111111111111111122222222222222222223111111111..........33334344111111111.333444111.....3334411.......",
"..333441133344111111111111111.........111111111111111111112222222222222222334111111111...........3433434411111111..333444111....3334411........",
"..333441133344111111111111111.........11111111111111111111122222222222222231111111111............343343431111111...333444111...3334411.........",
"..333441133344111111111111111........111111111111111111111122222222222222231111111111............34334333111111....333444111...3334411.........",
"..33334411334411111111111111.........111111111111111111111122222222222111111111111111............3433433411111.....333444111...3334411.........",
"...333441113441111111111111..........111111111111111111111112222222221111111111111111............3333334411111.....333444111...3334411.........",
"....3344111344111111111111...........111111111111111111111112222222222222211111111111............3333344411111.....333444111...3334411.........",
"....333441114411111111111............111111111111111111111111122222222222111111111111............3333444411111.....333444111..3334411..........",
"....3334411141111111111..............11111111111111111111111111122222222111111111111.............3333444411111.....333444111.3334411...........",
".....33344111111111111...............11111111111111111111111111111111111111111111111.............3333444411111.....3334441113334411............",
