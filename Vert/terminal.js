drawTerminal = function(selectedProgram) {
    ...
    for (let x = 0; x < face[0].length; x++) {
         for (let y = 0; y < face.length; y++) {
            let p = face[y][x];
             ...
             let sc = 4.54;
             // m += Math.cos(x * y * 0.01);
             let tx = -2.055, ty = 1.51;
             let osc = Math.sin(drawCount * 4e-2 + 2e-1 * x) * 0.1 - 0.6;
             if (p == "1" || p == "3" || p == "5") {
             if (p !== ".") {
                 let xx = x * 0.0025 * sc * (9 / 16) * 4 * 1.6 + tx + (Math.sin(drawCount * 0.125 + y * 0.25) * 0.0125 * 0.5);
    ...
    for (let x = 0; x < face[0].length; x++) {
         for (let y = 0; y < face.length; y++) {
            let p = face[y][x];
             ...
             if (p !== "1" || p !== "3" || p !== "5") {
             if (p !== ".") {
                 let xx = x * 0.0025 * sc * (9 / 16) * 4 * 1.6 + tx + (Math.cos(drawCount * 0.125 + y * 0.25) * 0.0125 * 0.5);
                 let yy = -y * 2.2 * sc * 0.0126 + Math.sin(drawCount * 0.25 + y * 0.25) * 0.0025 + ty - 0.02;
                 vertices.push(xx, yy, 20.0 * sc * 0.9, 1);
             num++;
             }
    ...
    for (let x = 0; x <= vt.stringArray[0].length; x++) {
        ...
        for (let y = 0; y < 9; y++) {
            ...
            if (vt.stringArray[y][x] == sel || (x == caret && drawCount / 20 % 1 < 0.5)) {
                let sc = 1;
            // if (Math.sin(x * y) > 0.5) {
            vertices.push(x * (9 / 16) * 0.02 * sc - 0.87, -y * 0.03 * sc - 0.7 - (Math.sin(drawCount * 0.25 + y) * 0.125e-2) - 0.04, 30.0 * sc, 1);
            // vertices.push(x * (9 / 16) * 0.02 * sc - 0.9 + Math.sin(y * 1e-1 + drawCount * 1e-1) * 0.05 * sc, -y * 0.03 * sc - 0.6 - (Math.sin(drawCount * 0.25 + y) * 1.5e-2 * sc), 45.0 * sc, 1);
                // vertices.push(x * (9 / 16) * 0.02 * sc - 0.87 - 0.03, (-y * 0.03 * sc - 0.7) - 0.02 - 0.065, 30.0 * sc * 0.9, 1.0);
                num++;
                colors.push(0, 0, 0);
            }
        }
    ...
    for (let i = 0; i < num; i++) {
        ...
        for (let y = 0; y < 9; y++) {
            ...
            if (vt.stringArray[y][x] == sel || (x == caret && drawCount / 20 % 1 < 0.5)) {
            // if (Math.sin(x * y) > 0.5) {
            vertices.push(x * (9 / 16) * 0.02 * sc - 0.87, -y * 0.03 * sc - 0.7 - (Math.sin(drawCount * 0.25 + y) * 0.125e-2), 30.0 * sc, 1);
            // vertices.push(x * (9 / 16) * 0.02 * sc - 0.9 + Math.sin(y * 1e-1 + drawCount * 1e-1) * 0.05 * sc, -y * 0.03 * sc - 0.6 - (Math.sin(drawCount * 0.25 + y) * 1.5e-2 * sc), 40.0 * sc, 1);
                // vertices.push(x * (9 / 16) * 0.02 * sc - 0.87 - 0.03, -y * 0.03 * sc - 0.7 - 0.05, 30.0 * sc * 0.9, 1);
                num++;
                let c = (Math.sin(-drawCount * 0.5e-1 + x * 1e-1) * 0.5 + 0.5) * 0.25 + 0.25;
                colors.push(c, c, c);
            }
        }
    }
...
roundedSquare.fragText = `
    ...
    void main(void) {
         ...
         vec2 uv = gl_PointCoord.xy;
        uv = uv * 2. - 1.;
        float color = roundedRectangleFlicker(uv, vec2(0.0, 0.0), vec2(0.129, 0.225) * 4.5, 0.0001, 0.05);
        float rando = rand(uv * ttime) * 0.05;
       float vig = (roundedRectangle(gl_FragCoord.xy, vec2(1280./ 2.0, 720./ 2.), vec2(0.8, 0.425) * 750., 20.5, 70.5) + 0.0);
        gl_FragColor = vec4((cols - rando), color * alph * vig);
    }
    // endGLSL
`;
roundedSquare.init();
...
vt2.makeTerminalString();
            ...
            "........05..05..05....05.05.55..55.05..05................25...25.05.....05.55...05.05....5555..",
            ".....05..05.05.05.....05.05.55..05.05.05..........333333.25..255.05.05..05.05...05.05....0505..",
            "......00000505.05......0505..05.05.05.05.........3333333325.25.0505..05.05.05...0505.....005...",
            "..........0505.05.......005...0505.05.05........33040222325.25..005..05.05.05...0505.....005...",
            "...........005005........05...0505.05.05........3300022232525....05..05.05.05...0505.....05....",
            "............0005.........05....005.0505.........3330222332525....05...0505.05...0505.....05....",
            "............005..........05.....05.005..........3333223332525....05....005.05...005......05....",
            "............05...........05.....05.05..........31111113112225....05....005.05...005......05....",
            "............05...........05.....05.05..........1111111111225.....05.....05.05...05.......05....",
            "............05...........05.....05.05.........1111111111125......05.....05.05...05.......05....",
            "............05...........05.....05.05........111111111111000.....05.....05.05...05.......05....",
