        ...
        for (let x = 0; x < face[0].length; x++) {
         for (let y = 0; y < face.length; y++) {
            let p = face[y][x];
             ...
             let osc = Math.sin(drawCount * 1e-1 + 1e-1 * x) * 0.1 - 0.4;
             if (p == "1") {
                 let xx = x * 0.0025 * sc * (9 / 16) * 4.4 * 1.6 + Math.sin(drawCount * 0.25 + y * 0.75) * 0.007 + tx;
                 let yy = -y * 2.65 * sc * 0.0126 + ty - 0.02;
                 vertices.push(xx, yy, 20.0 * sc * 0.9, 0.3 * ((Math.sin(drawCount * 0.25e-1) * 0.5) + 0.5));
                 num++;
                 if (p == "1") { colors.push(0, 0, 0); 
                 } else if (p == "0") {colors.push(0.75 + osc, 0.75 + osc, 0.75 + osc);
                 } else if (p == "2") {colors.push(0.5 + 0.65 - 0.2 + osc, 0.35 + 0.5 - 0.2 + osc, 0.5 + 0.2 - 0.2 + osc);
...
roundedSquare.fragText = `
    ...
    void main(void) {
         ...
         vec2 uv = gl_PointCoord.xy;
        uv = uv * 2. - 1.;
        float color = roundedRectangleFlicker(uv, vec2(0.0, 0.0), vec2(0.125, 0.28) * 4., 0.001, 0.1);
        float rando = rand(uv * time) * 0.05;
        gl_FragColor = vec4(cols - rando, color * alph);
    }
    // endGLSL
`;
roundedSquare.init();
...
vt2.makeTerminalString();
            ...
            ".................111111111111111111111444444444444444444444444411.",
            ".................11111111111111111111221111111114444444411111111..",
            ".................11111111111111111111222333333331133441144444444..",
            "................111111111111111111112223222112232222344443331134..",
            "................111111111111111111112233222112233222344433331134..",
            "................111111111111111111112222333333322222344444444444..",
            "...............1111111111111111111112222222222222222234444444444..",
            "...............1111111111111111111111222222222222222223444444444..",
            "...............1111111111111111111111222222222222222223444444444..",
            "...............111111111111111111111122222222222333344444334444...",
            "...............11111111111111111111111222222222222233332223334....",
            "..............111111111111111111111111222222222222233332222234....",
            "..............111111111111111111111111222222222111111112222341....",
            "..............111111111111111111111111222222221111111122223411....",
            "..............111111111111111111111111222222222222222222234111....",
            "..............111111111111111111111111333222222222222222341111....",
            "..............11111111111111111111111133333322222222223411111.....",
            "..............11111111111111111111111133333333333441111111111.....",
            "..............1111111111111111111111113333333333441111111111......",
