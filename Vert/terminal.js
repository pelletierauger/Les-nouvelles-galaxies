    ...
    let colors = [];
         ...
         for (let y = 0; y < face.length; y++) {
            let p = face[y][x];
             ...
             // m += Math.cos(x * y * 0.01);
             let tx = -1.12, ty = 1;
             let osc = Math.sin(drawCount * 0.5e-1 + 0.5e-1 * x) * 0.1 - 0.5;
             if (p !== ".") {
                 let xx = x * 0.0025 * sc * (9 / 16) * 4 * 1.6 + tx + (Math.sin(drawCount * 0.125 + y * 0.25) * 0.0125 * 0);
                 let yy = -y * 2.2 * sc * 0.0126 + Math.sin(drawCount * 0.125 + y * 0.25) * 0.0025 + ty - 0.02;
                 vertices.push(xx, yy, 20.0 * sc * 0.9, 1);
             num++;
             }
             if (p == "1") {
                 colors.push(0, 0 + 0.01, 0 + 0.1);                 
             } else if (p == "0") {
                colors.push(0.75 + osc, 0.75 + osc + 0.01, 0.75 + osc + 0.1);
             } else if (p == "2") {
                colors.push(0.6 + osc, 0.6 + osc + 0.01, 0.6 + osc + 0.1);
             }else if (p == "3") {
               colors.push(0.15 + osc, 0.15 + osc + 0.01, 0.15 + osc + 0.1);
             }else if (p == "4") {
                colors.push(0.7 + osc, 0.7 + osc + 0.01, 0.7 + osc + 0.1);
             }else if (p == "5") {
                colors.push(0.5 + osc, 0.5 + osc + 0.01, 0.5 + osc + 0.1);
             }
             // if (m < 0.5) {
...
roundedSquare.fragText = `
    ...
    void main(void) {
         ...
         vec2 uv = gl_PointCoord.xy;
        uv = uv * 2. - 1.;
        float color = roundedRectangleFlicker(uv, vec2(0.0, 0.0), vec2(0.14, 0.26) * 4.5, 0.001, 0.05);
        float rando = rand(uv * ttime) * 0.05;
       float vig = (roundedRectangle(gl_FragCoord.xy, vec2(1280./ 2.0, 720./ 2.), vec2(0.72, 0.392) * 840., 0.05, 120.5) + 0.0);
...
vt2.makeTerminalString();
            ...
            "......00000505.05......0505..05.05.05.05......3304033333.25.25.0505..05.05.05...0505.....005...",
            "..........0505.05.......005...0505.05.05......3300023333.25.25..005..05.05.05...0505.....005...",
            "...........005005........05...0505.05.05......3330222333.2525....05..05.05.05...0505.....05....",
            "............0005.........05....005.0505.......3333223333.2525....05...0505.05...0505.....05....",
            "............005..........05.....05.005........3333113333.2525....05....005.05...005......05....",
            "............05...........05.....05.05..........11111111..2225....05....005.05...005......05....",
            "............05...........05.....05.05.........1111111111.225.....05.....05.05...05.......05....",
