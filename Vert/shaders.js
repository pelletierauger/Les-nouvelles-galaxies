...
// 
    void main(void) {
        ...
        float x = cos(pow(i, sin(i * 2e4) * 1.5) * 20e1) * i * 2e-2;
        float y = sin(pow(i, sin(i * 2e4) * 1.5) * 20e1) * i * 2e-2;
        x += tan(x * 1e-4 + cos(i * cos(x * 1e2)) + t * 1e2) * 500.5;
        y += tan(y * 1e-4 + sin(i * cos(y * 1e2)) + t * 1e2) * 500.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 2.75e2) * i * 0.05;
        y += sin(t * 2.75e2) * i * 0.05;
        // x += 200. * cos(t * 16.);
        // y += 200. * sin(t * 16.);
        x *= 0.5e-3;
        y *= 0.5e-3;
