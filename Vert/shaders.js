...
// 
    void main(void) {
        ...
        float x = cos(tan(i * 1.5e-8) * 2e1 * i) * i * 16e-3;
        float y = sin(tan(i * 1.5e-8) * 2e1 * i) * i * 16e-3;
        x += tan(cos(i * 69. * tan(i * 1e-5)) * 1e4 * sin(t * 2e-3)) * 5000.5;
        y += tan(sin(i * 69. * tan(i * 1e-5)) * 1e4 * sin(t * 2e-3)) * 5000.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
