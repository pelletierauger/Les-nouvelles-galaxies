...
// 
    void main(void) {
        ...
        float x = min(cos(pow(i, 2.) * 0.00125) * 200., tan(i * 0.0001 + -t)) * i * 16e-4;
        float y = min(sin(pow(i, 2.) * 0.00125) * 200., tan(i * 0.0001 + -t)) * i * 16e-4;
//         x = cos(x) * x;
//         y = sin(y) + sin(x + 1e1 * t);
//         x += cos(x * 1e-1) * cos(i * 9000. * tan(i * 1e-3));
//         y += sin(y * 1e-1) * sin(i * 9000. * tan(i * 1e-3));
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 0.5e1) * i * 0.05;
        y += sin(t * 0.5e1) * i * 0.05;
        x *= 16e-5;
        y *= 16e-5;
