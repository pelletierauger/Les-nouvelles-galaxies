...
// 
    void main(void) {
        ...
        float x = cos(i + sin(i + tan(i * i * 4e-10 * 30. + tan(i * i + tan(i * i * 1e-1)) * 1e-4 + t * 0.5e1) * 1e-1 + t)) * i;
        float y = sin(i + sin(i + tan(i * i * 4e-10 * 30. + tan(i * i + tan(i * i * 1e-1)) * 1e-4 + t * 0.5e1) * 1e-1 + t)) * i;
//         x = cos(x) * x;
//         y = sin(y) + sin(x + 1e1 * t);
