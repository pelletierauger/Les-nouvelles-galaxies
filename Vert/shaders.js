...
// 
    void main(void) {
        ...
        float x = cos(i * 1.5e-6 * i) * i * 164e-3;
        float y = sin(i * 1.5e-6 * i) * i * 164e-3;
        x += tan((i * i * cos(i * 1e2 * sin(i * 2e3)) * 1e2) + osc / i * 1e4) * 5000.5;
        y += tan((i * i * sin(i * 1e2 * sin(i * 2e3)) * 1e2) + osc / i * 1e4) * 5000.5;
//         x *= 0.25 * 44.5;
        // y += cos(x * i) * x * 2e1;
        // x += sin(y * i) * y * 2.;
        x += cos(t * 0.75e2) * i * 0.2625;
        y += sin(t * 0.75e2) * i * 0.2625;
        // x += 1000. * cos(t * 1e1) * 1.;
        // y += 1000. * sin(t * 1e1) * 1.;
        x *= 5.5e-4;
        y *= 5.5e-4;
...
// 
    void main(void) {
        ...
        float osc = map(sin(t * 16e-1), -1., 1., 0.05, 4.005);
        float i = vertexID * 1e-1;
        float x = cos(pow(tan(i * 1.25e-7), 2.25) * 5e4 * i) * i * i * i * 8e-12;
        float y = sin(pow(tan(i * 1.25e-7), 2.25) * 5e4 * i) * i * i * i * 8e-12;
        x += cos(i * 690. * pow(tan(i * 2e-1), x) + i * 5e2) * 1000.5;
        y += sin(i * 690. * pow(tan(i * 2e-1), y) + i * 5e2) * 1000.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
