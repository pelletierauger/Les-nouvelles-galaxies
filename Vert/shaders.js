...
// 
    void main(void) {
        ...
        float x = cos(i * i * 0.5e-3 * -200.) * pow(i, 4.) * 8e-16;
        float y = sin(i * i * 0.5e-3 * -200.) * pow(i, 4.) * 8e-16;
        x += 1.0 + cos(i * 1e-4 * tan(i * 2e-4 + t)) * 0.5;
        y += 0.0 + sin(i * 1e-4 * tan(i * 2e-4 + t)) * 0.5;
//         x += cos(i * 2900. * tan(i * 2e-1)) * 0.5;
//         y += 0.0 + sin(i * 2900. * tan(i * 2e-1)) * 0.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 0.25e1) * i * 0.00005;
        y += sin(t * 0.25e1) * i * 0.00005;
                x -= 1.;
        x *= 1.115 * 0.25;
        y *= 1.115 * 0.25;
