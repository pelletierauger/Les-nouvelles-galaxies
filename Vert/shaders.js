...
// 
    void main(void) {
        ...
        float x = sin(pow(i, sin(i * 1e4)) * 1e-1 + cos(t * 1e1)) * i * 2e-2;
        float y = sin(pow(i, sin(i * 1e4)) * 1e-1 + sin(t * 1e1)) * i * 2e-2;
        x += tan(cos(i * 6. * tan(i * 1e-3)) + t * 1e2) * 500.5;
        y += tan(sin(i * 6. * tan(i * 1e-3)) + t * 1e2) * 500.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
