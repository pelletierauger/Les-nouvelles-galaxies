...
// 
    void main(void) {
        ...
        float x = cos(i * 1.5e-6 * i) * i * 64e-3;
        float y = sin(i * 1.5e-6 * i) * i * 64e-3;
        x += tan((i * i * cos(i * 1e2 * sin(i * 2e3)) * 1e2) + osc / i * 1e14) * 5000.5;
        y += tan((i * i * sin(i * 1e2 * sin(i * 2e3)) * 1e2) + osc / i * 1e14) * 5000.5;
//         x *= 0.25 * 44.5;
        // y += cos(x * i) * x * 2e1;
        // x += sin(y * i) * y * 2.;
