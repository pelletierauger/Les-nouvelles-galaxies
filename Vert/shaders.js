...
// 
    void main(void) {
        ...
        float y = mod(i, 5000.) * 1e-4;
        float x = floor(i / 5000.) * 0.5e-1 * sin(t);
        x += y * x * ((mod(x / 0.5e-1 * sin(t), 2.) * 2. - 1.) * 1.);
        x -= floor(i / 5000.) * 0.5e-1 * sin(t);
        y += floor(i / 5000.) * 4e-2;
        gl_Position = vec4(x * 2., y * 2. - 0.75, 0.0, 1.0);
        alph = 0.25 * 0.5;
        gl_PointSize = 7.0;
    }
    // endGLSL
...
// 
    void main(void) {
        ...
        float i = vertexID * 1e-1;
        float y = mod(i, 5000.) * 1e-4;
        float x = floor(i / 5000. * y * 2.) * 0.25e-1 * cos(y * 2.);
        x += y * x * ((mod(x / 0.25e-1, 2.) * 2. - 1.) * 1.);
        // x -= floor(i / 5000.) * 0.5e-1;
        // y += floor(i / 5000.) * 4e-2;
        gl_Position = vec4(x * 2., y * 2. - 0.75, 0.0, 1.0);
        alph = 0.25 * 0.5;
        gl_PointSize = 7.0;
...
// 
    void main(void) {
        ...
        float osc = map(sin(t * 16e-1), -1., 1., 0.05, 4.005);
        float i = vertexID * 1e-1;
        float y = mod(i, 1000.) * 1e-4;
        float x = floor(i / 1000.) * 0.125e-1;
        x += pow(y, 1.5 + (x * 0.125e1)) * 8. * x * ((mod(x / 0.125e-1, 2.) * 2. - 1.) * 1.);
        x -= floor(i / 1000.) * 0.125e-1;
        y += floor(i / 1000.) * 1e-2;
        
        x += sin(tan(i * 1e-2 + t * 1e1) * -1e-1) * floor(sin(i * 1e-3));
        // y += sin(tan(x * 1. + t * 1.) * -1e-1) * floor(sin(i * 1e-4));
        gl_Position = vec4(x * 4. * 1.25, y * 2. * 1.25 - 0.75, 0.0, 1.0);
        alph = 0.25 * 0.5;
        gl_PointSize = 7.0;
    }
    // endGLSL
...
// 
    void main(void) {
        ...
        float i = vertexID * 1e-1;
        float y = mod(i, 1000.) * 1e-4;
        float x = floor(i / 950.) * 0.125e-1;
        x += pow(y, 1.25 + (x * 0.125e1)) * 8. * x * ((mod(x / 0.125e-1, 2.) * 2. - 1.) * 1.);
        x -= floor(i / 950.) * 0.125e-1;
        y += floor(i / 950.) * 1e-2;
        x += (sin(i * 0.5e2)) * 0.5 / y;
        x += sin(tan(i * 1e-2 + t * 1e-2) * -1e1) * floor(sin(i * 1e-3)) * (y * 1.);
        y += sin(tan(x * 1. + t * 1.) * -1e-1) * floor(sin(i * 1e-4));
        gl_Position = vec4(x * 0.75 * 1.5, y * 2. * 1.5 - 1.2, 0.0, 1.0);
        alph = 0.25 * 0.5;
        gl_PointSize = 7.0;
    }
    // endGLSL
...
// 
    void main(void) {
        ...
        float osc = map(sin(t * 16e-1), -1., 1., 0.05, 4.005);
        float i = vertexID * 1e-1;
        float y = mod(i, 950.) * 1e-4;
        float x = floor(i / 950.) * 0.125e-1;
        x += pow(y, 1.25 + (x * 0.125e1)) * 8. * x * ((mod(x / 0.125e-1, 2.) * 2. - 1.) * 3.) * 0.5;
        x -= floor(i / 950.) * 0.125e-1;
        y += floor(i / 950.) * 1e-2;
        x += (sin(i * 0.75e2)) * 0.5 / y;
        // x += sin(tan(i * 1e-2 + t * 1e-2) * -1e1) * floor(sin(i * 1e-3)) * (y * x * 1.);
        // y += sin(tan(x * 1. + t * 1.) * -1e-1) * floor(sin(i * 1e-4));
        gl_Position = vec4(x * 0.75 * 1.5, y * 2. * 1.5 - 1.2, 0.0, 1.0);
        alph = 0.25 * 0.5;
        gl_PointSize = 7.0;
...
// 
    void main(void) {
        ...
        y += floor(i / 950.) * 1e-2;
        x += (sin(i * 0.75e2)) * 1.27;
        x += sin(tan(i * 1e-5 + t * 1e-2) * 1e3) * floor(sin(i * 1e-3)) * (y * x * 1.);
        // y += sin(tan(x * 1. + t * 1.) * -1e-1) * floor(sin(i * 1e-4));
        gl_Position = vec4(x * 0.75 * 1.5, y * 3. * 1.5 - 2.1, 0.0, 1.0);
        alph = 0.25 * 0.5;
        gl_PointSize = 7.0;
    }
    // endGLSL
