...
// 
    void main(void) {
        ...
        float x = cos(tan(i * 1.5e-8) * 2e-1 * t * i) * i * i * 8e-7;
        float y = sin(tan(i * 1.5e-8) * 2e-1 * t * i) * i * i * 8e-7;
        x += cos(i * 1900. * tan(i * 2e-2)) * 1500.5;
        y += sin(i * 1900. * tan(i * 2e-2)) * 1500.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 4.75) * i * 0.025;
        y += sin(t * 4.75) * i * 0.025;
        // x += 500. * cos(t * 5.);
        // y += 500. * sin(t * 5.);
        x *= 0.75e-3;
        y *= 0.75e-3;
