...
// 
    void main(void) {
        ...
        float x = cos(i * 0.5e1 * 0.01 * i) * pow(i, 4.) * 8e-16;
        float y = sin(i * 0.5e1 * 0.01 * i) * pow(i, 4.) * 8e-16;
        x += cos(i * 2069. * tan(i * 4e-8)) * (1.0 - (i * 1e-4)) * 25.;
        y += sin(i * 2069. * tan(i * 4e-8)) * (1.0 - (i * 1e-4)) * 25.;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 0.5) * i * 0.004;
        y += sin(t * 0.5) * i * 0.004;
