...
// 
    void main(void) {
        ...
        float x = cos(tan(i * 1e-3 + t * 2e1) * sin(i * 1e-3) * 1.1) * i * 2e-3 + cos(tan(i + i * 4e-1) * 1e3) * i * 16e-3;
        float y = sin(tan(i * 1e-3 + t * 2e1) * sin(i * 1e-3) * 1.1) * i * 2e-3 + sin(tan(i + i * 4e-1) * 1e3) * i * 16e-3;
//         x += cos(x * 1e-1) + cos(i * 6900. * tan(i * 2e-4)) * 0.5;
//         y += sin(y * 1e-1) + sin(i * 6900. * tan(i * 2e-4)) * 0.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
