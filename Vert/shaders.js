...
// 
    void main(void) {
        ...
        x += sin(cos(i * 4e2) * bx * 1e4 + cos(t * 4e-2)) * 400.5 * bx;
        y += sin(sin(i * 4e2) * by * 1e4 + sin(t * 4e-2)) * 400.5 * by;
        x += sin(cos(i * 4e2) * i * 1e-4) * 3400.;
        y += sin(sin(i * 4e2) * i * 1e-4) * 3400.;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 16.75e1) * i * 0.05;
        y += sin(t * 16.75e1) * i * 0.05;
