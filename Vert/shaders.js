...
// 
    void main(void) {
        ...
        float x = cos(pow(i, 3.75) * 0.125e-9 + t + tan(i * 1.5)) * cos(pow(i, 0.285)) * i * 1e-5;
        float y = sin(pow(i, 3.75) * 0.125e-9 + t + tan(i * 1.5)) * sin(pow(i, 0.285)) * i * 1e-5;
        x *= 0.25 * 94.5 * 0.79;
        y *= 0.25 * 94.5 * 0.79;
        x += cos(t * 15e-1) * i * 0.0000125;
        y += sin(t * 15e-1) * i * 0.0000125;
//         x *= osc;
//         y *= osc;
