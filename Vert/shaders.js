...
// 
    void main(void) {
        ...
        float x = cos(i * i * 0.05) * 8e-7;
        float y = sin(i * i * 0.05) * 8e-7;
        x += tan(x * 1900. * sin(i * 2e-1)) * 250000.5;
        y += tan(y * 1900. * sin(i * 2e-1)) * 250000.5;
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 10.75) * i * 0.015;
        y += sin(t * 10.75) * i * 0.015;
        // x += 500. * cos(t * 5.);
        // y += 500. * sin(t * 5.);
        x *= 1.75e-3;
        y *= 1.75e-3;
