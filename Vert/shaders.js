...
// 
    void main(void) {
        ...
        float x = cos(i + sin(i + tan(i * i * 4e-10 * 30. + sin(i * i + tan(i * i * 1e-1)) * 1e-4 + t * 0.5e1) * 1e-1 + t)) * i;
        float y = sin(i + sin(i + tan(i * i * 4e-10 * 30. + sin(i * i + tan(i * i * 1e-1)) * 1e-4 + t * 0.5e1) * 1e-1 + t)) * i;
//         x = cos(x) * x;
//         y = sin(y) + sin(x + 1e1 * t);
//         x *= cos(i * 9e3 * tan(i * 1e-5));
//         y *= sin(i * 9e3 * tan(i * 1e-5));
//         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
        x += cos(t * 0.4e1) * i * 0.5;
        y += sin(t * 0.4e1) * i * 0.5;
