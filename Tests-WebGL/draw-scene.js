...
drawDots = function() {
    ...
    for (let i = 0; i < 30000; i += 1) {
        x = sin(tan(i * 0.125 + t * sin(t)) + i * t * 0.000001) * i * 0.00005;
        y = cos(tan(i * 0.125 + t * sin(t)) + i * t * 0.000001) * i * 0.00005;
//         x *= sin(t * 15 * cos(y * 0.25));
...
//         y += (Math.random() - 0.5) * 0.00005;
        x += xOffset * 0.25;
        y += yOffset * 0.25;
        vertices.push(x * 0.12 * 5, y * 0.2 * 5, 0.0);
    }
